                ...
                <div class="card">
                    ...
                    ?>
                        <button class="btn btn-success " type="button" data-toggle="modal"
                            data-target="#Registration-Contrat-mixte"
                                                    ...
                                                    <form id="updateContratForm" autocomplete="off"
                                                        ...
                                                        <div class="form-group mb-4">
                                                            <label class="col-md-12 p-0">Nombre de kilomètres inclus<span
                                                                    class="text-danger">*</span></label>
                                                            <div class="col-md-12 border-bottom p-0">
                                                                <input type="number" id="up_NbreKilometreContrat"
                                                                    placeholder="1000"
                                                                    class="form-control p-0 border-0" required>
                                                            </div>
                                                        </div>
                                                        ...
                                                        <div id="up_inputNumCB" class="form-group mb-4"
                                                            ...
                                                            <div class="col-md-12 border-bottom p-0">
                                                                <input type="text" id="up_numCautionCBMateriel"
                                                        ...
                                                        <div id="up_inputNumChequeCaution" class="form-group mb-4"
                                                            ...
                                                            <div class="col-md-12 border-bottom p-0">
                                                                <input type="text" id="up_numCautionMateriel" data-inputmask="'mask': '9999999'" placeholder="XXXXXXX"
                                                                class="form-control p-0 border-0" required>
                                                            </div>
                                    ...
                                    <div class="modal fade" id="update-ContratAvenant" tabindex="-1" role="dialog"
                                        ...
                                        <div class="modal-dialog" role="document">
                                            <div class="modal-content">
                                                ...
                                                <div class="modal-footer">
                                                    <button class="btn btn-success"
                                                        id="btn_updated_ContratAvenant_Pack">Modifier
                                                        Contrat</button>
                                                    <button type="button" class="btn btn-danger" data-dismiss="modal"
                                                        id="btn-close">Fermer</button>
                                                </div>
                                                ...
                                                <div class="modal-body">
                                                    ...
                                                    <form id="contratpackForm" autocomplete="off"
                                                        class="form-horizontal form-material">
                                                            ...
                                                            <div class="col-md-12 border-bottom p-0">
                                                                <select id="Contrattype" name="Contrattype"
                                                                    onchange="selectcontratpack(this.value)"
                                                        ...
                                                        <div id="inputNumCB" class="form-group mb-4"
                                                            ...
                                                            <label class="col-md-12 p-0">N° Carte Bancaire de caution</label>
                                                            <div class="col-md-12 border-bottom p-0">
                                                                <input type="text" id="numCautionCBMixte"
                                                                name="card-num" size="18"  minlength="19" maxlength="19"
                                                                    placeholder="XXXX XXXX XXXX XXXX"
                                                                    class="form-control p-0 border-0" required>
                                                            </div>
                                                        ...
                                                        <div id="inputNumChequeCaution" class="form-group mb-4"
                                                            ...
                                                            <div class="col-md-12 border-bottom p-0">
                                                                <input type="number" id="CautionContratMixtecheque"
                                                                    placeholder="1000€"
                                                                    class="form-control p-0 border-0" required>
                                                            </div>
                                                        </div>
                                                                ...
                                                                <tr>
                                                                    <td>
                                                                        <div class="col-md-10 border-bottom p-0">
                                                                            <select id="contratpackagence" name="contratpackagence"
                                                                                placeholder="agence"
                                                                                onchange="affichier_pack_dispo()"
                                                                                class="form-control p-0 border-0"
                                                                                required>
                                                        ...
                                                        <div class="form-group mb-4" id="cont_DateDebutContratAvenant"
                                                            ...
                                                            <div class="col-md-12 border-bottom p-0">
                                                                <input type="date" id="DateDebutContratAvenant"
                                                                    onchange="List_Materiel_Pack_Avenant()"
                                                                    class="form-control p-0 border-0" required>
                                                            </div>
                                                        </div>
                                                        ...
                                                        <div class="form-group mb-4" id="cont_Cochevehiculemateriel"
                                                            style="display:none">
                                        ...
                                        <div class="modal-dialog" role="document">
                                            <div class="modal-content">
                                                ...
                                                <div class="modal-body">
                                                    ...
                                                    <form id="updateContratPackFormSigne" autocomplete="off"
                                                        class="form-horizontal form-material">
                                                        <div class="form-group mb-4">
                                                        ...
                                                        <div class="form-group mb-4">
                                                            ...
                                                            <div class="col-md-12 border-bottom p-0">
                                                                <input type="file" id="contratsigne_pack"
                                                ...
                                                <div class="modal-footer">
                                                    <button class="btn btn-success"
                                                        id="btn_updated_Contrat_Pack_Sigen">Modifier le 
