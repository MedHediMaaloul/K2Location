...
$query = "SELECT FC.id_facture,FC.id_client,FC.date_facture,FC.id_contrat,FC.date_arret,C.mode_de_paiement,C.prix,C.date_debut,C.date_fin,CL.id_client,CL.nom,CL.codetva,CL.adresse,A.id_agence,A.lieu_agence,A.tel_agence,V.pimm,V.id_voiture,MM.Marque,MM.Model
