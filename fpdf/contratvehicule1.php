...
$pdf->AddPage();
define('EURO',chr(128));
$pdf->SetTitle(utf8_decode("Contrat Véhicule_N°':"));
$pdf->Image('logok2.jpg',10,15,20,15);
$pdf->SetFont('Arial','B',8);
$pdf->Cell(50,4,utf8_decode('CONTRAT DE LOCATION N°'),0,2,'',false);

$pdf->Output('I',utf8_decode("Contrat Véhicule_N°:ff.pdf"));
