...
(function($) {
	...
	var strings = {
		...
		error_dateformat: 'Calendrier : Format de date incorrect {0}. Doit être "maintenant" ou "aaaa-mm-jj"',
		error_loadurl: 'Calendrier : l\'URL de l\'événement n\'est pas définie',
		error_where: 'Agenda : Mauvais sens de navigation {0}. Ne peut être que "next" ou "prev" ou "today"',
		error_timedevide: 'Calendrier : le paramètre de fractionnement de temps doit diviser 60 sans décimales. Quelque chose comme 10, 15, 30',

		no_events_in_day: 'Aucun contrat aujourd\'hui.',
		...
		time: '',
		events: '',
		before_time: 'Terminé avant',
		after_time: 'Commencé après',
