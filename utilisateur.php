                                                    ...
                                                    <form id="up-userForm" autocomplete="off"
                                                        ...
                                                        <div class="form-group mb-4">
                                                            <label class="col-md-12 p-0">Password<span
                                                                    class="text-danger">*</span></label>
                                                            <div class="col-md-12 border-bottom p-0">
                                                                <input type="password" id="up_userPassword"
                                                                    value="*****"
                                                                    class="form-control p-0 border-0">
                                                            </div>
                                                        ...
                                                        <div class="form-group mb-4">
                                                            <label class="col-md-12 p-0">Email<span
                                                                    class="text-danger">*</span></label>
                                                            <div class="col-md-12 border-bottom p-0">
                                                                <input type="text" id="up_userEmail"
                                                                    placeholder="contact@k2group.fr"
                                                                    class="form-control p-0 border-0">
                                                            </div>
                                            ...
                                            <div class="modal-content">
                                                ...
                                                <div class="modal-body">
                                                    ...
                                                    <form id="userForm" autocomplete="off"
                                                        ...
                                                        <div class="form-group mb-4" id="cont_userName">
                                                        ...
                                                        <div class="form-group mb-4" id="cont_userLogin">
                                                            <label class="col-md-12 p-0">Login<span
                                                                    class="text-danger">*</span></label>
                                                            <div class="col-md-12 border-bottom p-0">
                                                        ...
                                                        <div class="form-group mb-4" id="cont_userPassword">
                                                            <label class="col-md-12 p-0">Password<span
                                                                    class="text-danger">*</span></label>
                                                            <div class="col-md-12 border-bottom p-0">
                                                        ...
                                                        <div class="form-group mb-4">
                                                            ...
                                                            <select id="roletype" name="roletype"
                                                                onchange="selectrole(this.value)" placeholder="roletype"
                                                                class="form-control p-0 border-0" required="">
                                                                <option value="Selectionner" disabled selected>
                                                                    Selectionner Le Role</option>
                                                                <option value="responsable">Admin</option>
                                                                <option value="admin">Agent</option>
                                                                <option value="mecanicien">Mécanicien</option>
                                                            </select>
                                                        </div>
                                                        <div class="form-group mb-4" id="cont_UserAgence"
                                                            style="display:none">
                                                            <?php
