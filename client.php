                ...
                <div class="card">
                    <div class="card-heading">LISTE DES CLIENTS ACTIFS</div>
                        ...
                        <div class="row">
                            <div class="col-sm-12">
                                <div class="white-box">
                                    <div class="table-responsive" style="height: 460px;" id="client-list"></div>
                                    <!-- show file modal -->
                                    ...
                                    <div class="modal fade" id="showClient" tabindex="-1" role="dialog"
                                        ...
                                        <div class="modal-dialog" role="document">
                                            <div class="modal-content">
                                                <div class="modal-header">
                                                    <h5 class="modal-title" id="exampleModalLabel">Fiche Client Pro</h5>
                                                    <button type="button" class="close" data-dismiss="modal"
                                                        aria-label="Close">
                                                        <span aria-hidden="true">&times;</span>
                                                    </button>
                                            ...
                                            <div class="modal-content">
                                                ...
                                                <div class="modal-body">
                                                    ...
                                                    <form id="clientForm" autocomplete="off"
                                                        ...
                                                        <div class="col-md-12 border-bottom p-0">
                                                            <select id="Clienttype" name="Clienttype"
                                                                ...
                                                                <option value="Selectionner" disabled selected>
                                                                    Selectionner type de client</option>
                                                                <option value="CLIENT PRO">CLIENT PRO</option>
                                                                <option value="CLIENT PARTICULIER"> CLIENT PARTICULIER
                                                                </option>
                                                            </select>
                                                        </div>
                                                        <div class="form-group mb-4" id="cont_nom_complet_part"
                                                            style="display:none">
                                                            <label class="col-md-12 p-0">Nom Conducteur<span
                                                                    class="text-danger">*</span></label>
                                                            <div class="col-md-12 border-bottom p-0">
                                                                <input type="text" id="userName" placeholder="Conducteur Name"
                                                                    class="form-control p-0 border-0" required>
                                                            </div>
                                                        </div>
                                                        <div class="form-group mb-4" id="cont_nom_complet_pro"
                                                            style="display:none">
                                                            <label class="col-md-12 p-0">Nom de l'entreprise<span
                                                                    class="text-danger">*</span></label>
                                                            <div class="col-md-12 border-bottom p-0">
                                                                <input type="text" id="entrepriseName" placeholder="Entreprise Name"
                                                                    class="form-control p-0 border-0" required>
                                                            </div>
                                                        </div>
                                                        ...
                                                        <div class="form-group mb-4" id="cont_raison1"
                                                            style="display:none">
                                                            <label class="col-md-12 p-0">Raison Social<span
                                                                    class="text-danger">*</span></label>
                                                            <div class="col-md-12 border-bottom p-0">
                                                        ...
                                                        <div class="form-group mb-4" id="cont_nom_conducteur_pro"
                                                            style="display:none">
                                                            <label class="col-md-12 p-0">Nom Conducteur</label>
                                                            <div class="col-md-12 border-bottom p-0">
                                                                <input type="text" id="userNamepro" placeholder="Conducteur Name"
                                                                    class="form-control p-0 border-0" required>
                                                            </div>
                                                        </div>
                                                        <div class="form-group mb-4" id="cont_numpermisPro"
                                                            style="display:none">
                                                            <label class="col-md-12 p-0">Numéro Permis</label>
                                                            <div class="col-md-12 border-bottom p-0">
                                                                <input type="text" id="userNumPermisPro"
                                                                    placeholder="Numéro De Permis"
                                                                    class="form-control p-0 border-0">
                                                            </div>
                                                        </div>
                                                        <div class="form-group mb-4" id="cont_numpermisPart"
                                                            style="display:none">
                                                            <label class="col-md-12 p-0">Numéro Permis<span
                                                                    class="text-danger">*</span></label>
                                                            <div class="col-md-12 border-bottom p-0">
                                                                <input type="text" id="userNumPermisPart"
                                                                    placeholder="Numéro De Permis"
                                                                    class="form-control p-0 border-0">
                                                            </div>
                                                        </div>
                                                        ...
                                                        <div class="form-group mb-4" id="cont_naf" style="display:none">
                                                            <label class="col-md-12 p-0">Code NAF<span
                                                                    class="text-danger">*</span></label>
                                                            <div class="col-md-12 border-bottom p-0">
                                                                <input type="text" id="userNaf" placeholder="Code NAF"
                                                                    class="form-control p-0 border-0">
                                                            </div>
                                                        </div>
                                                        <div class="form-group mb-4" id="cont_tva" style="display:none">
                                                            <label class="col-md-12 p-0">Code TVA<span
                                                                    class="text-danger">*</span></label>
                                                            <div class="col-md-12 border-bottom p-0">
                                                                <input type="text" id="userTva" placeholder="User TVA"
                                                                    class="form-control p-0 border-0">
                                                            </div>
                                                        </div>
                                                        <div class="form-group mb-4" id="cont_date_entreprise"
                                                            style="display:none">
                                                            <label class="col-md-12 p-0">Date Création de l'entreprise<span
                                                                    class="text-danger">*</span></label>
                                                            <div class="col-md-12 border-bottom p-0">
                                                                <input type="date" min="0" id="userDateEntreprise"
                                                                    placeholder="User Date Entreprise"
                                                                    class="form-control p-0 border-0">
                                                            </div>
                                                        </div>
                                                        ...
                                                        <div class="form-group mb-4" id="cont_cin" style="display:none">
                                                            <label class="col-md-12 p-0">CNI<span
                                                                    class="text-danger"></span></label>
                                                            <div class="col-md-12 border-bottom p-0">
                                                        ...
                                                        <div class="form-group mb-4" id="cont_permis"
                                                            style="display:none">
                                                            <label class="col-md-12 p-0">Permis<span
                                                                    class="text-danger"></span></label>
                                                            <div class="col-md-12 border-bottom p-0">
                                                        ...
                                                        <div class="form-group mb-4" id="cont_kbis"
                                                            style="display:none">
                                                            <label class="col-md-12 p-0">KBIS<span
                                                                    class="text-danger"></span></label>
                                                            <div class="col-md-12 border-bottom p-0">
                                                        ...
                                                        <div class="form-group mb-4" id="cont_rib" style="display:none">
                                                            <label class="col-md-12 p-0">RIB<span
                                                                    class="text-danger"></span></label>
                                                            <div class="col-md-12 border-bottom p-0">
                                                        ...
                                                        <div class="form-group mb-4" id="cont_attestation"
                                                            style="display:none">
                                                            <label class="col-md-12 p-0">Attestation Responsabilité Civile<span
                                                                    class="text-danger"></span></label>
                                                            <div class="col-md-12 border-bottom p-0">
                                                                <input type="file" id="userAttestation"
                                                                    placeholder="Attestation Responsabilité Civile de Client"
                                                                    class="form-control p-0 border-0">
                                                            </div>
                                                        </div>
